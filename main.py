...
from utils.task_utils import TASK_CHOICES, build_dataset_kwargs, get_task_config
...
dataset_kwargs = build_dataset_kwargs(args.task, args.data_root_dir)
dataset_kwargs['seed'] = args.seed
dataset = Generic_MIL_Dataset(**dataset_kwargs)

if task_config.get('requires_subtyping') and args.model_type in ['clam_sb', 'clam_mb']:
